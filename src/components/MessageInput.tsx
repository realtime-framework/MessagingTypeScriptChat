...
export default class MessageInput extends React.Component<MessageInputProps, undefined> {
    ...
    sendMessage() {
        ...
        this.props.realtime.publish(this.props.channel, JSON.stringify(message), ttl, (err, seqId) => {
            if(err) {
